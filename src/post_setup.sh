...
[[ -d /etc/amazon ]] || sudo mkdir -p /etc/amazon
ln /snap/amazon-ssm-agent/current /etc/amazon/ssm
sudo cp -p /snap/amazon-ssm-agent/current/seelog.xml.template /snap/amazon-ssm-agent/current/seelog.xml
